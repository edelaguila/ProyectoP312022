...
public class frmMantenimientoVentas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
       ...
       modelo.addColumn("Producto");
        ...
        for (int i = 0; i < ventas.size(); i++) {
            ...
            dato[4] =ventas.get(i).fGetfecha_Venta();
            dato[5] = Integer.toString(ventas.get(i).fGetid_Cliente());
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        ventasAInsertar.fSetfecha_Venta(String.valueOf(lb));
