 ...
 * @author visitante
 */
public class mdiGeneralg2 extends javax.swing.JFrame {
    ...
    public mdiGeneralg2() {
        ...
        this.setExtendedState(mdiGeneralg2.MAXIMIZED_BOTH);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        // TODO add your handling code here:
        frmTipoDoctos ventana = new frmTipoDoctos();
        jDesktopPane1.add(ventana);
        Dimension desktopSize = jDesktopPane1.getSize();
        Dimension FrameSize = ventana.getSize();
        ventana.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mdiGeneralg2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mdiGeneralg2().setVisible(true);
            }
        });
    }
